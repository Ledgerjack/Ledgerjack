...
export const COUNTRY_REGIONS: TaxRegionConfig[] = [
  ...
  { id: 'au', label: 'Australia', countryCode: 'AU', currencySymbol: 'A$', currencyCode: 'AUD', fiscalYearStart: { month: 7, day: 1 }, mileageUnit: 'km', ...BASE_CONFIG('Revenue') },
  { id: 'ca', label: 'Canada', countryCode: 'CA', currencySymbol: 'C$', currencyCode: 'CAD', fiscalYearStart: { month: 1, day: 1 }, mileageUnit: 'km', ...BASE_CONFIG('Revenue') },
  { id: 'nz', label: 'New Zealand', countryCode: 'NZ', currencySymbol: 'NZ$', currencyCode: 'NZD', fiscalYearStart: { month: 4, day: 1 }, mileageUnit: 'km', ...BASE_CONFIG('Revenue') },
  { id: 'ie', label: 'Ireland', countryCode: 'IE', currencySymbol: '€', currencyCode: 'EUR', fiscalYearStart: { month: 1, day: 1 }, mileageUnit: 'km', ...BASE_CONFIG('Turnover') },
  { id: 'de', label: 'Germany', countryCode: 'DE', currencySymbol: '€', currencyCode: 'EUR', fiscalYearStart: { month: 1, day: 1 }, mileageUnit: 'km', ...BASE_CONFIG('Umsatz') },
  { id: 'fr', label: 'France', countryCode: 'FR', currencySymbol: '€', currencyCode: 'EUR', fiscalYearStart: { month: 1, day: 1 }, mileageUnit: 'km', ...BASE_CONFIG('Chiffre d\'affaires') },
  { id: 'es', label: 'Spain', countryCode: 'ES', currencySymbol: '€', currencyCode: 'EUR', fiscalYearStart: { month: 1, day: 1 }, mileageUnit: 'km', ...BASE_CONFIG('Ingresos') },
  { id: 'it', label: 'Italy', countryCode: 'IT', currencySymbol: '€', currencyCode: 'EUR', fiscalYearStart: { month: 1, day: 1 }, mileageUnit: 'km', ...BASE_CONFIG('Fatturato') },
  { id: 'nl', label: 'Netherlands', countryCode: 'NL', currencySymbol: '€', currencyCode: 'EUR', fiscalYearStart: { month: 1, day: 1 }, mileageUnit: 'km', ...BASE_CONFIG('Omzet') },
  { id: 'be', label: 'Belgium', countryCode: 'BE', currencySymbol: '€', currencyCode: 'EUR', fiscalYearStart: { month: 1, day: 1 }, mileageUnit: 'km', ...BASE_CONFIG('Revenue') },
  { id: 'ch', label: 'Switzerland', countryCode: 'CH', currencySymbol: 'CHF', currencyCode: 'CHF', fiscalYearStart: { month: 1, day: 1 }, mileageUnit: 'km', ...BASE_CONFIG('Ertrag') },
  { id: 'se', label: 'Sweden', countryCode: 'SE', currencySymbol: 'kr', currencyCode: 'SEK', fiscalYearStart: { month: 1, day: 1 }, mileageUnit: 'km', ...BASE_CONFIG('Intäkter') },
  { id: 'no', label: 'Norway', countryCode: 'NO', currencySymbol: 'kr', currencyCode: 'NOK', fiscalYearStart: { month: 1, day: 1 }, mileageUnit: 'km', ...BASE_CONFIG('Inntekter') },
  { id: 'dk', label: 'Denmark', countryCode: 'DK', currencySymbol: 'kr', currencyCode: 'DKK', fiscalYearStart: { month: 1, day: 1 }, mileageUnit: 'km', ...BASE_CONFIG('Omsætning') },
  { id: 'fi', label: 'Finland', countryCode: 'FI', currencySymbol: '€', currencyCode: 'EUR', fiscalYearStart: { month: 1, day: 1 }, mileageUnit: 'km', ...BASE_CONFIG('Liikevaihto') },
  { id: 'pl', label: 'Poland', countryCode: 'PL', currencySymbol: 'zł', currencyCode: 'PLN', fiscalYearStart: { month: 1, day: 1 }, mileageUnit: 'km', ...BASE_CONFIG('Przychód') },
  { id: 'pt', label: 'Portugal', countryCode: 'PT', currencySymbol: '€', currencyCode: 'EUR', fiscalYearStart: { month: 1, day: 1 }, mileageUnit: 'km', ...BASE_CONFIG('Volume de negócios') },
  { id: 'at', label: 'Austria', countryCode: 'AT', currencySymbol: '€', currencyCode: 'EUR', fiscalYearStart: { month: 1, day: 1 }, mileageUnit: 'km', ...BASE_CONFIG('Umsatz') },
  { id: 'sg', label: 'Singapore', countryCode: 'SG', currencySymbol: 'S$', currencyCode: 'SGD', fiscalYearStart: { month: 1, day: 1 }, mileageUnit: 'km', ...BASE_CONFIG('Revenue') },
  { id: 'hk', label: 'Hong Kong', countryCode: 'HK', currencySymbol: 'HK$', currencyCode: 'HKD', fiscalYearStart: { month: 4, day: 1 }, mileageUnit: 'km', ...BASE_CONFIG('Revenue') },
  { id: 'in', label: 'India', countryCode: 'IN', currencySymbol: '₹', currencyCode: 'INR', fiscalYearStart: { month: 4, day: 1 }, mileageUnit: 'km', ...BASE_CONFIG('Revenue') },
  { id: 'za', label: 'South Africa', countryCode: 'ZA', currencySymbol: 'R', currencyCode: 'ZAR', fiscalYearStart: { month: 3, day: 1 }, mileageUnit: 'km', ...BASE_CONFIG('Revenue') },
  { id: 'br', label: 'Brazil', countryCode: 'BR', currencySymbol: 'R$', currencyCode: 'BRL', fiscalYearStart: { month: 1, day: 1 }, mileageUnit: 'km', ...BASE_CONFIG('Receita') },
  { id: 'mx', label: 'Mexico', countryCode: 'MX', currencySymbol: 'MX$', currencyCode: 'MXN', fiscalYearStart: { month: 1, day: 1 }, mileageUnit: 'km', ...BASE_CONFIG('Ingresos') },
  { id: 'ae', label: 'UAE', countryCode: 'AE', currencySymbol: 'د.إ', currencyCode: 'AED', fiscalYearStart: { month: 1, day: 1 }, mileageUnit: 'km', ...BASE_CONFIG('Revenue') },
  { id: 'jp', label: 'Japan', countryCode: 'JP', currencySymbol: '¥', currencyCode: 'JPY', fiscalYearStart: { month: 4, day: 1 }, mileageUnit: 'km', ...BASE_CONFIG('売上高') },
  { id: 'generic', label: 'Other / International', countryCode: 'XX', currencySymbol: '$', currencyCode: 'USD', fiscalYearStart: { month: 1, day: 1 }, mileageUnit: 'km', ...BASE_CONFIG('Revenue') },
];
